  ...
  <div class="wrapper">
          ...
          <ul class="top-nav">
            <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-lg"></i></a>
              <ul class="dropdown-menu settings-menu">
                <li><a href="profil.php"><i class="fa fa-male fa-lg"></i>Profil</a></li><hr>
    ...
    <div class="content-wrapper">
      <div class="page-title">
        <div>
          <h1><i class="fa fa-table"></i>  Sistem Informasi Kependudukan</h1>
        </div>
        <div>
          <ul class="breadcrumb">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="widget-small info"><i class="icon fa fa-database fa-3x"></i>
                  <?php
                  $query = mysql_query("SELECT count(*) totalpenduduk FROM data_penduduk");
                  $datapenduduk = mysql_fetch_array($query);
                  ?>
                  <div class="info">
                    <h4>Data Penduduk</h4>
                    <p> <b><?php echo $datapenduduk['totalpenduduk']; ?></b></p>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
              <div class="widget-small danger"><i class="icon fa fa-female fa-2x"></i>
                <?php
                $query = mysql_query("SELECT jenis_kelamin, count(*) AS totallk FROM data_penduduk WHERE jenis_kelamin='PEREMPUAN' GROUP BY jenis_kelamin");
                $jk = mysql_fetch_array($query);
                ?>
                <div class="info">
                  <h4>PEREMPUAN</h4>
                  <p> <b><?php echo $jk['totallk']; ?></b></p>
                </div>
              </div>
            </div>
             <div class="col-md-4">
              <div class="widget-small danger"><i class="icon fa fa-male fa-2x"></i>
                <?php
                $query = mysql_query("SELECT jenis_kelamin, count(*) AS totallk FROM data_penduduk WHERE jenis_kelamin='LAKI-LAKI' GROUP BY jenis_kelamin");
                $jk = mysql_fetch_array($query);
                ?>
                <div class="info">
                  <h4>LAKI-LAKI</h4>
   ...
   <footer>
    <div class="container-fluid">
      <p class="copyright">&copy; 2020. Sistem Informasi Kependudukan</p>
    </div>
  </footer>
</div>
</div>
