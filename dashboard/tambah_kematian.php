      ...
      <div class="modal-body">
        <div class="modal-content">
          ...
          <div class="container-fluid" style="margin-bottom: 30px">
            ...
            <form action="list_kematian.php" method="POST" role="form" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                 ...
                 <a href="list_kematian.php" class="btn btn-primary fa fa-back">KEMBALI</a>
