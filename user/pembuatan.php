    ...
    <aside class="main-sidebar hidden-print">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="pembuatan.php"><i class="fa fa-plus"></i><span>Pembuatan KTP</span></a></li>
        ...
        <div class="modal-content">
          <div class="container-fluid" style="margin-bottom: 30px">
            ...
            if(isset($_POST['submit'])){
              ...
              $cek = mysql_query("SELECT * FROM data_penduduk WHERE NIK='$NIK'") or die(mysql_error($koneksi));

              if(mysql_num_rows($cek) == 0){
                $sql = mysql_query("INSERT INTO data_penduduk(NIK, nama, tempat_lahir, tanggal_lahir, jenis_kelamin, gol_darah, alamat, RT_RW, desa, kecematan, agama, status_perkawinan, pekerjaan, kewarganegaraan, foto) VALUES('$NIK', '$nama', '$tempat_lahir', '$tanggal_lahir', '$jenis_kelamin', '$gol_darah', '$alamat', '$RT_RW', '$desa', '$kecematan', '$agama', '$status_perkawinan', '$pekerjaan', '$kewarganegaraan', '$foto')") or die(mysql_error($koneksi));
            ...
            <form action="list_penduduk.php" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" name="kecematan" class="form-control" required>
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">STATUS_PERKAWINAN</label>
              <div class="col-sm-10">
