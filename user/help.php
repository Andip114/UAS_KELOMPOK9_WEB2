...
<head>
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <header class="main-header hidden-print"><a class="logo" href="index.php" style="font-size:13pt">Sistem Informasi</a>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                ...
                <li>Menu Pembuatan KTP merupakan menu untuk mengisi formulir pembuatan KTP.</li>
                ...
                <br>
                Untuk Lebih Jelasnya Silakan Download File Modulnya  <a href="https://drive.google.com/file/d/1Srn4RPIqPAbWyed7ArhCYkcrWZUCp5b-/view?usp=sharing">Disini</a>
              </div>
            </div>
          </div>
        </div>
