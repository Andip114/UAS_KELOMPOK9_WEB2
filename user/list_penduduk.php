        ...
        <div class="row">
          <div class="col-xs-12">
           ...
           <!--  <a href="tambah_penduduk.php" class="btn btn-primary fa fa-plus">Tambah</a>
            <a href="excel_penduduk.php" class="btn btn-primary fa fa-download">Cetak Data</a> -->
          </div>
                      ...
                      <div class="container" style="margin-bottom: 30px">
                        ...
                        if(isset($_POST['submit'])){
                          ...
                          if(mysql_num_rows($cek) == 0){
                            $sql = mysql_query("INSERT INTO data_penduduk(NIK, nama, tempat_lahir, tanggal_lahir, jenis_kelamin, gol_darah, alamat, RT_RW, desa, kecematan, agama, status_perkawinan, pekerjaan, kewarganegaraan) VALUES('$NIK', '$nama', '$tempat_lahir', '$tanggal_lahir', '$jenis_kelamin', '$gol_darah', '$alamat', '$RT_RW', '$desa', '$kecematan', '$agama', '$status_perkawinan', '$pekerjaan', '$kewarganegaraan')") or die(mysql_error($koneksi));
