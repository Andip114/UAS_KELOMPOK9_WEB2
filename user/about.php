      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <legend>Sistem Informasi Kependudukan Desa Politeknik</legend>
                <p>Sistem ini berisi tentang data penduduk, kematian dan kelahiran pada desa politeknik. <br>
                Bisa juga membuat surat pembuatan ktp serta lainnya</p>
              </div>
            </div>
          </div>
        </div>
