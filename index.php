...
<body>
  ...
  <section class="login-content">
    ...
    <!-- <div>
     <a href="index1.php" class="btn btn-primary pull-left fa fa-user">user</a> |
     <a href="index.php" class="btn btn-primary fa fa-user">admin</a>
   </div> -->
   <div class="login-box">
      ...
      <div class="form-group btn-container">
        <button class="btn btn-primary btn-block" name="login">Login <i class="fa fa-sign-in fa-lg"></i></button><br>
          <div>
            ...
            <br>
            <br>
            <a href="register.php" class="pull-right">Not Have Account? Register Now!</a>
      </div>
